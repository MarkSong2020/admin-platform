...
ListGuard = Annotated[CurrentUser, Depends(require_permission("system:role:list"))]
QueryGuard = Annotated[CurrentUser, Depends(require_permission("system:role:query"))]
AddGuard = Annotated[CurrentUser, Depends(require_permission("system:role:add"))]
EditGuard = Annotated[CurrentUser, Depends(require_permission("system:role:edit"))]
RemoveGuard = Annotated[CurrentUser, Depends(require_permission("system:role:remove"))]
...
@router.get("", operation_id="roles_list", response_model=RolePage, responses=AUTH_ERROR_RESPONSES)
