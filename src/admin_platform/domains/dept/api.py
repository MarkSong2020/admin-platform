...
QueryGuard = Annotated[CurrentUser, Depends(require_permission(Permissions.SYSTEM_DEPT_QUERY))]
AddGuard = Annotated[CurrentUser, Depends(require_permission(Permissions.SYSTEM_DEPT_ADD))]
EditGuard = Annotated[CurrentUser, Depends(require_permission(Permissions.SYSTEM_DEPT_EDIT))]
RemoveGuard = Annotated[CurrentUser, Depends(require_permission(Permissions.SYSTEM_DEPT_REMOVE))]
