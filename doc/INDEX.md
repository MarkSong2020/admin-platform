...
> 当前 P0–P4 全落地（auth + RBAC + 审计持久化 + 字典·参数·通知 + 监控·在线用户·定时任务，单租户）+ P5 文件管理已落地（对标 RuoYi sys_oss，spec [`../docs/specs/2026-06-11-p5-file-management.md`](../docs/specs/2026-06-11-p5-file-management.md)）；P5 范围 codegen 砍除（AI 时代），剩 Excel 导入导出（待依赖授权）+ P6 Vue 前端。对标路线图见 [`../docs/specs/2026-06-04-ruoyi-parity-roadmap.md`](../docs/specs/2026-06-04-ruoyi-parity-roadmap.md)。
