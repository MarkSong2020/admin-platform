...
| 4 | 跨语言协同 ADR | ✅ 完成（独立仓 `team-engineering-adr/`） |
...
- `docs/adr/0001-*.md` 迁到 `team-engineering-adr/`
...
### v0.4.5 — 知识库重组（仿 java-reference-service）
...
| 2026-05-15 | 知识库仿 java-reference-service doc/ 七目录 | v0.4.5 |
...
- ADR Revision history → `team-engineering-adr/0001-cross-language-conventions.md`
