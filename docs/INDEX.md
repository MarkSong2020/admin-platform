...
- 跨语言 ADR 正本 → 内部 ADR 仓（不公开）（不在本仓，[stub](./reference/CROSS_LANGUAGE_ADR.md)）
...
参见 [archive/EVOLUTION.md](./archive/EVOLUTION.md) 了解本知识库是如何演进过来的（v0.1 散落 4 文件 → v0.4 仿 某成熟后端项目 7 目录）。
