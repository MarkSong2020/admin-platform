...
冲突治理：`~/IdeaProjects/team-engineering-adr/service-prefix-registry.md`（团队前缀注册表，ADR Open Q11 v0.4.5 已决议落地）—— 新前缀必须先在 registry 走 PR 注册。
...
| `APP_DATABASE_URL` | `database_url` | `postgresql+asyncpg://app:app@localhost:5432/app` |
...
- 全部命名规则的强制力来源：`~/IdeaProjects/team-engineering-adr/0001-cross-language-conventions.md` §3 / §4 / §7 / §8 / §10
...
- 服务前缀注册：`~/IdeaProjects/team-engineering-adr/service-prefix-registry.md`
